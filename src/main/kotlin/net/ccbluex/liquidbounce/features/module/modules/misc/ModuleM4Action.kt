...
/**
 * Allows you to perform actions with the fourth mouse button.
 */
object ModuleM4Action : ClientModule("M4Action", ModuleCategories.MISC) {
    ...
    object FriendClicker : TickPlayerClickMode(GLFW.GLFW_MOUSE_BUTTON_4, "FriendClicker") {
    ...
    object TargetLock : TickPlayerClickMode(GLFW.GLFW_MOUSE_BUTTON_4, "TargetLock", listOf("Target")) {
        override val raycast = tree(PlayerClickRaycastSettings())
    ...
    object Pearl : TickPearlMode(GLFW.GLFW_MOUSE_BUTTON_4) {
