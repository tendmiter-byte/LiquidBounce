...
data class PlayerData(
    ...
    val vehicleHealth: Float,
    val vehicleMaxHealth: Float,
    val yaw: Float,
    val pitch: Float,
    val armor: Int,
    val food: Int,
    ...
    companion object {
        ...
        fun fromPlayer(player: Player) = PlayerData(
            ...
            (player.vehicle as? net.minecraft.world.entity.LivingEntity)?.health?.fixNaN() ?: 0f,
            (player.vehicle as? net.minecraft.world.entity.LivingEntity)?.maxHealth?.fixNaN() ?: 0f,
            player.yRot.fixNaN(),
            player.xRot.fixNaN(),
